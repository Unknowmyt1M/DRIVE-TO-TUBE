...
from pytube import YouTube  # Import pytube as a backup downloader
...
# Configure database for SQLite temporarily
...
def download_video():
    ...
    try:
        ...
        # Simplified approach - use a direct system command
        cmd = f"yt-dlp -f 'mp4' -o '{temp_file_mp4}' '{url}'"
